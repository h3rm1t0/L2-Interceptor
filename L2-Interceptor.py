...
def main():
    ...
    if pkt_discover is None:
        print (f"[DEBUG] Host alvo não respondeu ao pacote de descoberta. Alvo pode estar offline, rejeitando ou realizando drop do pacote.")
        exit
    ...
    try:
        ...
        print (f"[DEBUG] Sinal de interrupção recebido, iniciando saída do script.")
        close()
